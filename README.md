# A web application that allows patients to make an appointment with a doctor, indicating the symptoms that bother them, filling out a form and sending an application.
